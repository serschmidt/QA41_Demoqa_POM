...
//    release Shift key
  ...
  public ElementsPage verfyPath(String path) {
  ...
  public ElementsPage performMouseEvent() {
    ...
    int y = dimension.getHeight() / 4 +100;
    robot.mouseMove(x,y);
    pause(1000);
  ...
  public ElementsPage verifyTitelOfPageWithJS() {
  ...
  public ElementsPage enterPersonalDate(String name, String email) {

    moveWithJS(userName, 0 , 200);
    type(userName,name);
